function [ Data_STB_Light ] = STB_Rot( Data_STB_Light,cal_center,axis_cam2tool,Position_Matrix, angles_Base2Abs )
...
[Data_STB_Light] = cam2tool( Data_STB_Light, cal_center, axis_cam2tool);
