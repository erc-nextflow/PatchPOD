function [] = mat2tec_X_U_Up(X, U, U_std, varargin)
	...
	savematrix = [x, y, z, u, v, w, umag, u_std, v_std, w_std, omega_x, omega_y, omega_z, OMEGA, Q, No_Part, isValid];
	fid = fopen(filename, 'w');

	fprintf(fid, '%s\n', ['TITLE = "' filename '"']);
	fprintf(fid, '%s\n', 'VARIABLES = "X", "Y", "Z", "U [m/s]", "V [m/s]", "W [m/s]", "|U| [m/s]", "U_std [m/s]", "V_std [m/s]", "W_std [m/s]", "OmX [Hz]", "OmY [Hz]", "OmZ [Hz]", "|Om| [Hz]", "Q", "No_Part", "isValid" ');
