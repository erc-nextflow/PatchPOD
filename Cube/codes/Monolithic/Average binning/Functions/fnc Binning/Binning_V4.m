function [ output_args ] = Binning_V4(binsize, Data_Output, name , Process_Name, Pin)
...
tic
[U , Ustd, RS] = kd_cut_binning_V5(A, Data_Output(:,1:3)', Data_Output(:,4:6)', dx, No_Slices , Min_np_found);
bintime = toc;
...
if (Pin.opt)
    ...
    p = averagepressure2_mod(Pin.rho,xoc/1000,yoc/1000,zoc/1000,U,RS,mask,Niter);  % Very important to use SI units! Thus, coordinates transferred from m to mm
