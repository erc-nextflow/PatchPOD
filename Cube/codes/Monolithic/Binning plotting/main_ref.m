...
%% Load binned data
% Open File
FileName = '..\Average binning\Output\gauss_10mm.mat';
FileName = '..\Instantaneous binning\Output\Sequence_2_60mm.mat';
load(FileName);
...
trasl = -0;
%binned slice at y = 0
s = surf(squeeze(Output.x(slice + trasl,:,:)),squeeze(Output.y(slice + trasl,:,:)),squeeze(Output.z(slice + trasl,:,:)),squeeze(Output.snapshot_10.u(slice + trasl,:,:)));
